...
class JpegEncoder(object):
    def __init__(self, width=224, height=224, fps=21):
        ...
        GST_STRING = (
            "appsrc name=src emit-signals=True is-live=True caps=video/x-raw,format=BGR,width={width},height={height},framerate={fps}/1 !"
            " nvjpegenc "
            "! image/jpeg,width={width},height={height},framerate={fps}/1 !"
            " appsink name=sink".format(width=width, height=height, fps=fps)
        )
